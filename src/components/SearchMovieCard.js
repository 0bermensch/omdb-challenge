...
//   const { addMovieToNominateList, nominateList } = useContext();

//   let storeNominateMovie = nominateList.find((o) => o.id === info.id);

//   const nominateDisabled = storeNominateMovie ? true : false;
...
//           <h4 className="release-date">{info.Year}</h4>
//         </div>
//         <div className="controls">
//           <button
//             className="btn"
